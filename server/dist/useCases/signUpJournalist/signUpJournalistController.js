        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        journalistSignUpResponse = _c.sent();
                        if (!journalistSignUpResponse.success) {
                            msg = journalistSignUpResponse.msg, statusCode = journalistSignUpResponse.statusCode;
                            return [2 /*return*/, HttpResponses_1.customHttpResponse(res, { msg: msg, statusCode: statusCode })];
                        }
                        return [2 /*return*/, HttpResponses_1.created(res, journalistSignUpResponse)];
                }
            });
        });
    };
    return SignUpJournalistController;
}());
