...
var GetPostController = /** @class */ (function () {
    function GetPostController(getPostUseCase) {
        this.getPostUseCase = getPostUseCase;
    }
    GetPostController.prototype.handle = function (req, res) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (isNaN(id))
                            return [2 /*return*/, HttpResponses_1.badRequest(res, "invalid id param")];
