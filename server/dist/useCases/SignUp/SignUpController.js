            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.signUpUseCase.execute(userDto)];
                    case 1:
                        loginResponse = _c.sent();
                        if (!loginResponse.success) {
                            msg = loginResponse.msg, statusCode = loginResponse.statusCode;
                            return [2 /*return*/, HttpResponses_1.customHttpResponse(res, { msg: msg, statusCode: statusCode })];
                        }
                        return [2 /*return*/, HttpResponses_1.created(res, loginResponse)];
                }
            });
        });
    };
    SignUpController.prototype.getMissingProps = function (req) {
        var missingProps = [];
        var body = req.getBody();
        var requiredProps = ["name", "password", "email"];
        for (var _i = 0, requiredProps_1 = requiredProps; _i < requiredProps_1.length; _i++) {
            var propName = requiredProps_1[_i];
            var prop = body[propName];
            var bodyHasProp = Boolean(prop);
